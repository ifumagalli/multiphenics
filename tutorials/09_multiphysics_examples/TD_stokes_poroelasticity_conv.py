...
for ii in range(1,7):
    ...
    FuS = rhoS/dt * dot(uS_OLD,vS) * dx(stokes) \
          + (1-theta)*(\
    ...
    GqP = 1.0/dt * pP_OLD*qP * dx(poroel) \
          + (1-theta)*( \
    ...
    postprocess(sol_OLD, ii, 0, outputPath, outputFileBasename, err_uS_L2, err_uS_H10, err_pS_L2, err_uP_L2, err_uP_H10, err_pP_L2, err_pP_H10)
